...
from authControlApi.serializers import UserGroupSerializer, GroupSerializer, UserInfoSerializer, RoleSerializer
from mwer_utils.crud import Exsql
from django.db import transaction
from authControlApi.utils.auth import Authentication, SvipPermission, Mythrottle
...
class UserView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            with transaction.atomic():
                c = Exsql()
                sql = '''select username, user_type from authControlApi_userinfo order by username'''
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            res = c.get_all_dict('''SELECT 
                ...
                FROM `authControlApi_userinfo` t
                    inner join authControlApi_usergroup y
                on t.group_id = y.id
...
from authControlApi.utils.auth import MyCursorPagination
